...
class SiYuanApiAdaptor implements IBlogApi {
    ...
    constructor(cfg: Env | SiyuanConfig) {
        this.logger = ZhiUtil.zhiLog("siyuan-api-adaptor")
    ...
    public async getPost(postid: string, useSlug?: boolean): Promise<Post> {
        ...
        // 渲染Markdown
        let html = this.common.markdownUtil.renderHTML(md.content)
        // 移除挂件html
        ...
        commonPost.post_status = isPublished
            ? PostStatusEnum.PostStatusEnum_Publish
            : PostStatusEnum.PostStatusEnum_Draft
