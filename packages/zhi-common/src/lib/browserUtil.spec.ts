...
describe("BrowserUtil", () => {
   ...
   */
  it("should add a new parameter to the URL if it does not already exist", ({ expect }) => {
    const url = "https://example.com/"
    const key = "foo"
    const value = "bar"
    const expected = "https://example.com/?foo=bar"
   ...
   */
  it("should replace the value of an existing parameter in the URL", ({ expect }) => {
    const url = "https://example.com/?foo=bar&baz=qux"
    const key = "foo"
    const value = "baz"
    const expected = "https://example.com/?foo=baz&baz=qux"
   ...
   */
  it("should handle URLs with a hash fragment", ({ expect }) => {
   ...
   */
  it("should handle URLs with a question mark in the hash fragment", ({ expect }) => {
    const url = "https://example.com/#foo?bar"
    const key = "baz"
    const value = "qux"
    const expected = "https://example.com/?baz=qux#foo?bar"
   ...
   */
  it("should handle URLs with existing parameters that contain the new parameter's key", ({ expect }) => {
