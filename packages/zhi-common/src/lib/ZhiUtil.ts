    ...
    public static zhiLog(loggerName: string) {
        ...
        if (ZhiUtil.loggerMap) {
            ...
            if (ZhiUtil.loggerMap[loggerName]) {
                ...
                ZhiUtil.loggerMap[loggerName] = LogFactory.customSignLogFactory("zhi-common", env).getLogger(
                    loggerName
                )
            ...
            const env = ZhiUtil.zhiEnv()
            ZhiUtil.loggerMap = {}
            ZhiUtil.loggerMap[loggerName] = LogFactory.customSignLogFactory("zhi-common", env).getLogger(loggerName)
